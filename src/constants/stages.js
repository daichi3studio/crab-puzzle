...
export const STAGES = [
  // ── Zone 1: BOOT SECTOR (25s, comboTarget ×3) ────────────────
  { id:  1, name: 'BUG #001', subtitle: 'Hello Bug',       zone: 1, target:  220, timeLimit: 25, obstacles: 0, obstacleRate: 0.00, comboTarget: 2 },
  ...
  // ── Zone 2: MEMORY LEAK (28s, comboTarget ×3) ────────────────
  ...
  { id:  8, name: 'BUG #008', subtitle: 'Garbage Collect', zone: 2, target:  660, timeLimit: 28, obstacles: 0, obstacleRate: 0.00, comboTarget: 2 },
  { id:  9, name: 'BUG #009', subtitle: 'Dangling Ptr',    zone: 2, target:  730, timeLimit: 28, obstacles: 0, obstacleRate: 0.00, comboTarget: 2 },
  { id: 10, name: 'BUG #010', subtitle: 'Out of Memory',   zone: 2, target:  810, timeLimit: 28, obstacles: 0, obstacleRate: 0.00, comboTarget: 2 },

  // ── Zone 3: STACK OVERFLOW (28s, comboTarget ×4, no obstacles) ─
  ...
  { id: 14, name: 'BUG #014', subtitle: 'Buffer Overrun',  zone: 3, target:  880, timeLimit: 28, obstacles: 0, obstacleRate: 0.00, comboTarget: 3 },
  { id: 15, name: 'BUG #015', subtitle: 'Segfault',        zone: 3, target:  970, timeLimit: 28, obstacles: 0, obstacleRate: 0.00, comboTarget: 3 },

  // ── Zone 4: NULL POINTER (30s, comboTarget ×5, obstacles from stage 20) ─
  ...
  { id: 19, name: 'BUG #019', subtitle: 'Type Mismatch',   zone: 4, target: 1420, timeLimit: 30, obstacles: 0, obstacleRate: 0.00, comboTarget: 4 },
  { id: 20, name: 'BUG #020', subtitle: 'Access Denied',   zone: 4, target: 1560, timeLimit: 30, obstacles: 1, obstacleRate: 0.03, comboTarget: 4 },

  // ── Zone 5: DEADLOCK (30s, comboTarget ×5) ───────────────────
  { id: 21, name: 'BUG #021', subtitle: 'Mutex Lock',      zone: 5, target: 1700, timeLimit: 30, obstacles: 1, obstacleRate: 0.03, comboTarget: 4 },
  { id: 22, name: 'BUG #022', subtitle: 'Thread Stall',    zone: 5, target: 1870, timeLimit: 30, obstacles: 2, obstacleRate: 0.04, comboTarget: 4 },
  { id: 23, name: 'BUG #023', subtitle: 'Circular Wait',   zone: 5, target: 2050, timeLimit: 30, obstacles: 2, obstacleRate: 0.04, comboTarget: 4 },
  { id: 24, name: 'BUG #024', subtitle: 'Starvation',      zone: 5, target: 2200, timeLimit: 30, obstacles: 3, obstacleRate: 0.05, comboTarget: 4 },
  { id: 25, name: 'BUG #025', subtitle: 'Priority Invert', zone: 5, target: 2350, timeLimit: 30, obstacles: 3, obstacleRate: 0.05, comboTarget: 4 },

  // ── Zone 6: RACE CONDITION (30s, comboTarget ×6) ─────────────
  ...
  { id: 28, name: 'BUG #028', subtitle: 'Lost Update',     zone: 6, target: 2950, timeLimit: 30, obstacles: 5, obstacleRate: 0.07, comboTarget: 5 },
  { id: 29, name: 'BUG #029', subtitle: 'Phantom Read',    zone: 6, target: 3150, timeLimit: 30, obstacles: 5, obstacleRate: 0.07, comboTarget: 5 },
  { id: 30, name: 'BUG #030', subtitle: 'Fork Bomb',       zone: 6, target: 3380, timeLimit: 30, obstacles: 6, obstacleRate: 0.08, comboTarget: 5 },

  // ── Zone 7: KERNEL PANIC (30s, comboTarget ×6) ───────────────
  { id: 31, name: 'BUG #031', subtitle: 'Kernel Panic',    zone: 7, target: 3650, timeLimit: 30, obstacles: 6, obstacleRate: 0.09, comboTarget: 5 },
  { id: 32, name: 'BUG #032', subtitle: 'System Failure',  zone: 7, target: 3950, timeLimit: 30, obstacles: 7, obstacleRate: 0.10, comboTarget: 5 },
  { id: 33, name: 'BUG #033', subtitle: 'Core Dump',       zone: 7, target: 4300, timeLimit: 30, obstacles: 7, obstacleRate: 0.10, comboTarget: 5 },
  { id: 34, name: 'BUG #034', subtitle: 'Watchdog Fail',   zone: 7, target: 4700, timeLimit: 30, obstacles: 8, obstacleRate: 0.11, comboTarget: 5 },
  { id: 35, name: 'BUG #035', subtitle: 'Fatal Exception', zone: 7, target: 5200, timeLimit: 30, obstacles: 8, obstacleRate: 0.12, comboTarget: 5 },

  // ── Zone 8: SYSTEM MELTDOWN (30s, comboTarget ×6) ────────────
  { id: 36, name: 'BUG #036', subtitle: 'Thermal Runaway', zone: 8, target: 5500, timeLimit: 30, obstacles:  9, obstacleRate: 0.13, comboTarget: 5 },
  { id: 37, name: 'BUG #037', subtitle: 'Clock Skew',      zone: 8, target: 5900, timeLimit: 30, obstacles:  9, obstacleRate: 0.14, comboTarget: 5 },
  { id: 38, name: 'BUG #038', subtitle: 'Power Surge',     zone: 8, target: 6300, timeLimit: 30, obstacles: 10, obstacleRate: 0.15, comboTarget: 5 },
  { id: 39, name: 'BUG #039', subtitle: 'Bit Flip',        zone: 8, target: 6700, timeLimit: 30, obstacles: 10, obstacleRate: 0.16, comboTarget: 5 },
  { id: 40, name: 'BUG #040', subtitle: 'Total Collapse',  zone: 8, target: 7000, timeLimit: 30, obstacles: 10, obstacleRate: 0.18, comboTarget: 5 },
];
